...
import { createNotification, createNotificationForAllStores } from '@/actions/actions';
...
export default function Page() {
  ...
  const SentToStore = async () => {
    try {
      setisPending(true)
      const res = await createNotification(storeId,message,"TuniPod Admin")
      if(res){
        setisPending(false)
        toast({
  ...
  const SendToAllStores = async () => {
    ...
    try {
      setisPending(true)
      const res = await createNotificationForAllStores(message,"TuniPod Admin")
      if(res){
        setisPending(false)
        toast({
