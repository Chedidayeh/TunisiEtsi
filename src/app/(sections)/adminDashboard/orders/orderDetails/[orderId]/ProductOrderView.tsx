      ...
      <CardDescription>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 mt-2">
          ...
          <div>
            ...
            <p>{order.isSellerOrder ? "Yes" : "No"}</p>
          </div>
          <div>
          ...
          <div className="col-span-2 md:col-span-1">
          <Button onClick={handleType} variant="link" className="block">Change Type <FileType className="ml-1"/></Button>
          </div>
        </div>
      </CardDescription>
    </div>
     ...
     <CardDescription>
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-8 mt-2">
         ...
         <div>
           ...
           <p>{selectedItem.product.sellerProfit * selectedItem.quantity} TND</p>
         </div>
         <div>
