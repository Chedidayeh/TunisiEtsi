...
import {  fetchFripProductsByCategory, fetchProductsByCategory, getAllFripBrands, getUser } from '@/actions/actions'
...
export default async function Page({ params }: PageProps) {
  ...
  const categoryProducts = await fetchFripProductsByCategory(decodedCategory);
