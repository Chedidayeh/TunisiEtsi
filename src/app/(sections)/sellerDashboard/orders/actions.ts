  ...
  try {
    ...
    const result = orders.map((orderItem) => {
      ...
      return {
        ...
        frontDesign: orderItem.frontsellerDesign ? orderItem.frontsellerDesign.name : null,
        backDesign: orderItem.backsellerDesign ? orderItem.backsellerDesign.name : null,
        frontDesignProfit,
        backDesignProfit,
      };
    });
