...
import { ArrowRight, Box, CircleDollarSign, GraduationCap, Heart, Home, LayoutPanelTop, Palette, School, Shirt, ShoppingCart, UserRoundCog } from 'lucide-react'
import {
  Avatar,
  AvatarFallback,
  AvatarImage,
          ...
          <Dialog>
            ...
            <SheetContent side="left" className='w-[60%]'>
              ...
              Frip Market
                ...
                <DialogClose>
                <Link href="/BacProducts" className={buttonVariants({
              size: 'sm',
              variant: 'ghost',
